This is my blog(running using Jekyll) and hosted on Github. ~~I'll be migrating my wp blog posts over here as soon as I can find a stable enough plugin to do that. ~~. 
